/*
  ...
  gengetopt --input=args_parser.gengetopt --include-getopt 
...
const char *gengetopt_args_info_purpose = "Performs classification on timeseries.";

const char *gengetopt_args_info_usage = "Usage: clf [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --query_filename=STRING   Name of file containing query timeseries.",
  "      --reference_filename=STRING\n                                Name of file containing reference timeseries.",
  "      --x=STRING                UID of first timeseries to compare.",
  "      --y=STRING                UID of second timeseries to compare.",
  "  -v, --verbose                 Provide detailed output.  (default=off)",
  "  -t, --use_time_domain         Compare timeseries wrt absolute time.\n                                  (default=off)",
  "  -p, --print_warp_path         Show the warp path of compared timeseries.\n                                  (default=on)",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->query_filename_given = 0 ;
  args_info->reference_filename_given = 0 ;
  args_info->x_given = 0 ;
  args_info->y_given = 0 ;
  args_info->verbose_given = 0 ;
  args_info->use_time_domain_given = 0 ;
  args_info->print_warp_path_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->query_filename_arg = NULL;
  args_info->query_filename_orig = NULL;
  args_info->reference_filename_arg = NULL;
  args_info->reference_filename_orig = NULL;
  args_info->x_arg = NULL;
  args_info->x_orig = NULL;
  args_info->y_arg = NULL;
  args_info->y_orig = NULL;
  args_info->verbose_flag = 0;
  args_info->use_time_domain_flag = 0;
  args_info->print_warp_path_flag = 1;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->query_filename_help = gengetopt_args_info_help[2] ;
  args_info->reference_filename_help = gengetopt_args_info_help[3] ;
  args_info->x_help = gengetopt_args_info_help[4] ;
  args_info->y_help = gengetopt_args_info_help[5] ;
  args_info->verbose_help = gengetopt_args_info_help[6] ;
  args_info->use_time_domain_help = gengetopt_args_info_help[7] ;
  args_info->print_warp_path_help = gengetopt_args_info_help[8] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->query_filename_arg));
  free_string_field (&(args_info->query_filename_orig));
  free_string_field (&(args_info->reference_filename_arg));
  free_string_field (&(args_info->reference_filename_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->query_filename_given)
    write_into_file(outfile, "query_filename", args_info->query_filename_orig, 0);
  if (args_info->reference_filename_given)
    write_into_file(outfile, "reference_filename", args_info->reference_filename_orig, 0);
  ...
  if (args_info->use_time_domain_given)
    write_into_file(outfile, "use_time_domain", 0, 0 );
  if (args_info->print_warp_path_given)
    write_into_file(outfile, "print_warp_path", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->query_filename_given)
    {
      fprintf (stderr, "%s: '--query_filename' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->reference_filename_given)
    {
      fprintf (stderr, "%s: '--reference_filename' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        { "help",	0, NULL, 'h' },
        { "version",	0, NULL, 'V' },
        { "query_filename",	1, NULL, 0 },
        { "reference_filename",	1, NULL, 0 },
        { "x",	1, NULL, 0 },
        { "y",	1, NULL, 0 },
        { "verbose",	0, NULL, 'v' },
        { "use_time_domain",	0, NULL, 't' },
        { "print_warp_path",	0, NULL, 'p' },
        { 0,  0, 0, 0 }
      };
      ...
      c = custom_getopt_long (argc, argv, "hVvtp", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'v':	/* Provide detailed output..  */
          ...
          break;
        case 't':	/* Compare timeseries wrt absolute time..  */
        
        
          if (update_arg((void *)&(args_info->use_time_domain_flag), 0, &(args_info->use_time_domain_given),
              &(local_args_info.use_time_domain_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "use_time_domain", 't',
              additional_error))
            goto failure;
        
          break;
        case 'p':	/* Show the warp path of compared timeseries..  */
        
        
          if (update_arg((void *)&(args_info->print_warp_path_flag), 0, &(args_info->print_warp_path_given),
              &(local_args_info.print_warp_path_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "print_warp_path", 'p',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          /* Name of file containing query timeseries..  */
          if (strcmp (long_options[option_index].name, "query_filename") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->query_filename_arg), 
                 &(args_info->query_filename_orig), &(args_info->query_filename_given),
                &(local_args_info.query_filename_given), optarg, 0, 0, ARG_STRING,
          ...
          /* Name of file containing reference timeseries..  */
          else if (strcmp (long_options[option_index].name, "reference_filename") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->reference_filename_arg), 
                 &(args_info->reference_filename_orig), &(args_info->reference_filename_given),
                &(local_args_info.reference_filename_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "reference_filename", '-',
                additional_error))
              goto failure;
          ...
          /* UID of first timeseries to compare..  */
          else if (strcmp (long_options[option_index].name, "x") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->x_arg), 
                ...
                &(local_args_info.x_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "x", '-',
                additional_error))
              goto failure;
          ...
          /* UID of second timeseries to compare..  */
